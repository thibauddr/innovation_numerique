...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.herve.app.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.herve.app.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.herve.app.domain.User.class.getName());
            createCache(cm, com.herve.app.domain.Authority.class.getName());
